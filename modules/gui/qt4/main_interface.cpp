...
MainInterface::MainInterface( intf_thread_t *_p_intf ) : QVLCMW( _p_intf )
{
     ...
     * Synchronicity Bar *
     *********************/
    createSynchronicityBar();
    setSynchronicityBarVisibility( getSettings()->value( "synchronicity-bar-visible", false ).toBool() );
...
void MainInterface::createSynchronicityBar() {
    /*********************
    * Synchronicity Bar  *
    **********************/
    ...
    CONNECT( THEMIM, synchronicityUserChanged( char * ), this, updateUser ( char * ) );
